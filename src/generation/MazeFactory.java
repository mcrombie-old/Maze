...
public class MazeFactory implements Factory {
	...
	public boolean order(Order order) {
		...
		case DFS :
			builder = deterministic? new MazeBuilder(true) : new MazeBuilder(false);
			buildOrder();
			break;
		case Prim:
			builder = deterministic? new MazeBuilderPrim(true) : new MazeBuilderPrim(false);
			buildOrder();
			break;
		case Kruskal:
			builder = deterministic? new MazeBuilderPrim(true) : new MazeBuilderKruskal(false);
			buildOrder();
			break;
		default:
