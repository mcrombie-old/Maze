...
public class MazeView extends DefaultViewer {
	...
	void redrawFinish(Graphics gc) {
		...
		//additional code for pathLength and energy consumed
		centerString(gc, fm, "Total length of path followed is " + controller.driverPathLength, 180);
		centerString(gc, fm, "Total energy consumed is " + controller.driverEnergyConsumed, 200);
