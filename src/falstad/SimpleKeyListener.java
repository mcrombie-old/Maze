...
public class SimpleKeyListener implements KeyListener {
	...
	public void keyPressed(KeyEvent arg0) {
		...
		if (KeyEvent.CHAR_UNDEFINED == key)
		{
			...
			/*We also need to adjust the maze application class to provide us with a user interface such that
			1. we can select a robot driver algorithm (plus one option for a manual operation).
			2. we can select a maze generation algorithm (the MazeBuilder algorithm, Prim, Kruskal)*/
